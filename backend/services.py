...
def get_lab_member(cursor, fname: str, lname: str) -> pyodbc.Row:
...
def insert_lab_member(cursor, fname: str, lname: str, mtype: str, join_date) -> bool:
    ...
    # insert into major and Student/Faculty etc as well?
...
def get_ext_collab(cursor, ext_collab_id: int)-> pyodbc.Row:
...
# Student
def get_student(cursor, student_member_id: int)-> pyodbc.Row:
...
# Major
def get_major(cursor, student_member_id: int)-> pyodbc.Row:
...
# Projects
def get_project(cursor, project_title: str)-> pyodbc.Row:
...
# Project Status
def get_project_status(cursor, project_title: str)-> pyodbc.Row:
...
def get_equipment_status(cursor, equip_name: str)-> pyodbc.Row:
...
# Equipment CRUD
def get_equipment(cursor, equipment_name: str)-> pyodbc.Row:
...
# Usage
def get_usage(cursor, equip_id: int, lab_member_id: int)-> pyodbc.Row:
...
def get_busiest_publishers(cursor)-> pyodbc.Row:
...
def get_prolific_members(cursor, grant_id: int)-> pyodbc.Row:
